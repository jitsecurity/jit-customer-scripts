...
help:
	...
	@echo " self-hosted-runner centos runner_token=<runner-token> jit_repo=<jit-repo-name>  Set up self-hosted runner on CentOS"
	@echo " self-hosted-runner ubuntu runner_token=<runner-token> jit_repo=<jit-repo-name>  Set up self-hosted runner on Ubuntu"
